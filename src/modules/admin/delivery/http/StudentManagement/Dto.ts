    ...
    z.object({
        ...
        email: z
            ...
            .openapi({
                ...
                example: "nguyenvana@e.tlu.edu.vn",
            }),
        password: z
            .string()
            .trim()
...
export const CreateStudentRequestSchema = z
    .object({
        ...
        dateOfBirth: z.coerce
            ...
            .optional()
            .openapi({
                description: "Ngày sinh (chấp nhận chuỗi ngày ISO, ví dụ 2002-01-15)",
                example: "2002-01-15",
            }),
        address: z
            .string()
        ...
        accountId: z
            ...
            .optional()
            .openapi({
                description: "ID tài khoản liên kết (nếu có) - backward compatibility",
                example: "cmnztabnn0000e8vmyzb8gqtn",
            }),
...
export const StudentResponseSchema = z
    .object({
        ...
        dateOfBirth: z.string().nullable().openapi({
            ...
            example: "2002-01-15T00:00:00.000Z",
        }),
