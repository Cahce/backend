...
export async function buildApp(): Promise<FastifyInstance> {
    ...
    // 5. JWT (depends on app.config.auth and app.prisma)
    await app.register(jwtPlugin);

    // 6. Swagger (only if enabled - generates OpenAPI spec for Postman)
